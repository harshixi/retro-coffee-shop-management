...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        AccountSystem_window.title('RETRO COFFEE SHOP')
        ...
        brand_name = Label(landing_page, text='RETRO COFFEE SHOP', bg='#8A360F', fg='#ff6c38', font=("yu gothic ui", 20, "bold"))
        brand_name.place(x=83, y=13)
        ...
        logo.image = photo
        logo.place(x=10, y=35)

        brand_name = Label(sign_in, text='RETO COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        ...
        brand_name = Label(sign_up, text='RETRO COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)
